...
class BookingSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        booking_day = Booking.objects.filter(car=car, parking=parking, date=date1).first()
    ...
    def is_booking_day_valid(booking_day, start, end):
        ...
        start_datetime1 = datetime.combine(date.today(), booking_day.start)
        end_datetime1 = datetime.combine(date.today(), booking_day.end)
